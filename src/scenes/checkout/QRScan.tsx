        ...
        <Col span={16} flex={'auto'} style={{ padding: '1rem' }}>
          <div>
            ...
            >
              ...
              {bill && (
                <QRCode
                  value={`http://${import.meta.env.VITE_BACKEND_API_URL as string}/api/bills/paid/${bill.billId}?qr_path=http://${import.meta.env.VITE_BACKEND_API_URL as string}/api/bills/paid/${bill.billId}`}
